...
The standard multivariate LSTM with 35 features underperformed (25.88\% MAPE) compared to univariate LSTM (21.90\% MAPE), Bidirectional LSTM with 19 features (21.46\% MAPE), and the optimized Simple LSTM with 9 features (19.93\% MAPE). This demonstrates that model architecture, regularization strength, and feature quality matter more than simply maximizing feature quantity. The Goldilocks principle applies—too few features lose information, too many introduce noise and overfitting.

\subsection{Architectural Simplicity with Aggressive Feature Selection Wins}
\label{subsec:simple_lstm_advantage}

The Simple LSTM's success demonstrates that architectural simplicity combined with aggressive feature selection (9 features from 163) produces superior generalization compared to complex architectures. The 5.95 percentage point improvement over standard multivariate LSTM (19.93\% vs 25.88\% MAPE) and 1.53 point advantage over Bidirectional LSTM (19.93\% vs 21.46\%) validates the principle of parsimony in machine learning.
