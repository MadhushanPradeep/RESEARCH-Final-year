...
[SCREENSHOT: Time series plot of daily carrot prices]\\
\vspace{0.2cm}
}}
...
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{6cm}
[SCREENSHOT: Scatter plot of carrot price vs Central Highland precipitation with trend line]\\
\vspace{0.2cm}
}}
...
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{6cm}
[SCREENSHOT: Scatter plot of carrot price vs Uva Province precipitation]\\
\vspace{0.2cm}
}}
...
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{6cm}
[SCREENSHOT: Scatter plot of carrot price vs Northern region precipitation]\\
\vspace{0.2cm}
}}
...
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{6cm}
[SCREENSHOT: Scatter plot of carrot price vs Diesel (LAD) price with trend line]\\
\vspace{0.2cm}
}}
...
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{6cm}
[SCREENSHOT: Scatter plot of carrot price vs Petrol LP 95 price]\\
\vspace{0.2cm}
}}
...
[SCREENSHOT: Four-panel seasonal decomposition plot showing Observed, Trend, Seasonal, and Residual components]\\
\vspace{0.2cm}
}}
...
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{6cm}
[SCREENSHOT: Bar chart showing number of features at each pipeline stage: 289 → 80 → 60-65 → 35-40 → 24-35]\\
\vspace{0.2cm}
}}
...
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{8cm}
[SCREENSHOT: 19×19 correlation heatmap with color gradient]\\
\vspace{0.2cm}
}}
...
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{8cm}
[SCREENSHOT: Four-panel ARIMA diagnostic plot with standardized residuals, histogram, Q-Q plot, correlogram]\\
\vspace{0.2cm}
}}
...
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{6cm}
[SCREENSHOT: Two-panel plot showing Loss and MAPE curves across epochs for train/validation]\\
\vspace{0.2cm}
}}
...
[SCREENSHOT: Horizontal bar chart of top 20 features with importance scores]\\
\vspace{0.2cm}
}}
...
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{6cm}
[SCREENSHOT: Bar chart showing MAPE increase when removing each feature category]\\
\vspace{0.2cm}
}}
...
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{7cm}
[SCREENSHOT: SHAP beeswarm plot showing feature contributions]\\
\vspace{0.2cm}
}}
...
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{6cm}
[SCREENSHOT: SHAP dependence plot for price\_lag\_1 feature]\\
\vspace{0.2cm}
}}
