...
\begin{enumerate}
    \item \textbf{Data Acquisition:} Comprehensive data gathering from multiple authoritative sources including market prices, weather data, fuel prices, and supply indicators
    \item \textbf{Data Preprocessing:} Rigorous quality assurance including missing value treatment, outlier detection, and data transformation
    \item \textbf{Exploratory Data Analysis:} Visual and statistical analysis to understand patterns, trends, and relationships
    \item \textbf{Feature Engineering:} Creation of lag features, rolling statistics, temporal features, and interaction terms
    \item \textbf{Feature Selection:} Systematic identification of most relevant predictors using Random Forest importance, Mutual Information, and Recursive Feature Elimination
    \item \textbf{Model Development:} Implementation of ARIMA, LSTM (univariate, multivariate, bidirectional), and Random Forest models
    \item \textbf{Model Evaluation:} Comprehensive performance assessment using multiple metrics and statistical validation
    \item \textbf{AI Agent Deployment:} Integration of best model into Retrieval-Augmented Generation system for accessible predictions
\end{enumerate}
...
\textbf{Market Indicators:} Supply factors from various cultivation regions, demand levels at Dambulla market, trading activity indicators, and market operational status (open/closed, holidays) were compiled from agricultural market reports and official databases. These variables capture market dynamics beyond simple price-weather relationships.

\subsection{Dataset Characteristics}

The final integrated dataset comprised 2,013 daily observations with 127 initial variables before feature engineering. Key characteristics include:

\begin{itemize}
    \item Temporal span: January 1, 2020 to July 31, 2025 (67 months)
    \item Target variable: Carrot price (Rs/kg) at Dambulla wholesale market
    \item Price range: Rs. 120.00 to Rs. 350.00, mean Rs. 215.40, standard deviation Rs. 48.92
    \item Missing values: Approximately 2\% across variables, addressed through forward filling
    \item Data quality: High, with systematic validation and outlier treatment
\end{itemize}
